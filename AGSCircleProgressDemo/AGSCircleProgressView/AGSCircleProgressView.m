...
#pragma mark 动画绘制圆环-AGSDrawCircleView
@interface AGSDrawCircleView : UIView
@property (nonatomic, assign) CGFloat progress;

@property (nonatomic, strong) AGSCircleViewConfig *configure;

@end
@implementation AGSDrawCircleView
...
@end
@implementation AGSCircleProgressView
{
    
    AGSDrawCircleView *_circleView;
    AGSCircleViewConfig *_configure;
}

- (instancetype)initWithFrame:(CGRect)frame configure:(AGSCircleViewConfig *)configure
{
    self = [super initWithFrame:frame];
    if (self) {
        //保存配置
        ...
        //添加圆环
        [self addDrawCircleView];
        
    }
    return self;
}
- (void)addDrawCircleView {
    
    AGSDrawCircleView *circleView = [[AGSDrawCircleView alloc]initWithFrame:self.bounds];
...
@implementation AGSCircleViewConfig
